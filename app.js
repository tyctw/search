        ...
        if (data.found) {
          ...
          resultDiv.innerHTML = `
            ...
            <div class="report-info">
              <p><strong>時間戳記：</strong> <span class="info-value">${formattedDate}</span></p>
              <p><strong>回報者電子郵件：</strong> <span class="info-value">${data.email}</span></p>
              <p><strong>問題類別：</strong> <span class="info-value">${data.category}</span></p>
              <p><strong>問題描述：</strong> <span class="info-value">${data.description}</span></p>
            </div>
...
function updateThemeToggleIcon(isDarkMode) {
  ...
  if (isDarkMode) {
    themeToggle.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zM2 13h2c.55 0 1-.45 1-1s-.45-1-1-1H2c-.55 0-1 .45-1 1s.45 1 1 1zm18 0h2c.55 0 1-.45 1-1s-.45-1-1-1h-2c-.55 0-1 .45-1 1s.45 1 1 1zm0 16H8V7h11v14z"/></svg>';
  } else {
